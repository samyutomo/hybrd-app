...
var onsiteEventList = [
  HybridEvent(
    ...
    hybridType: 'https://i.pinimg.com/564x/25/73/60/257360090f31136c580695f7bee402df.jpg'
  ),
  HybridEvent(
    tag: "sushi",
    name: "Sushi Hiro",
...
var onlineEventList = [
  HybridEvent(
    ...
    hybridType: 'https://i.pinimg.com/564x/1b/87/7f/1b877fc422ad6bf3e8bf9768fa8d966e.jpg'
  ),
  HybridEvent(
    tag: "indgo",
    ...
    hybridType: 'https://i.pinimg.com/564x/cd/8b/9f/cd8b9f844b12078115e4eabd4f98e1a5.jpg'
  ),
  HybridEvent(
    tag: "optm",
    ...
    hybridType: 'https://i.pinimg.com/564x/28/90/fe/2890fe8532ae2b8b63edd21d5d5cd67f.jpg',
  ),
];
